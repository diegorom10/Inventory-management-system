          ...
          <div class="modal-body"> 
            ...
            <form id="ajuste-form" style="width: 80%">  
              ...
              <div class="form-group d-flex flex-column align-items-center">
                  ...
                  <div class="col-md-3">
									  <input type="number" min="1" max="100" name="cantidad" id="cantidad_nueva2" class="form-control input-ajuste" disabled>
                  </div>
              </div>
              <div class="form-group d-flex flex-column align-items-center">
              ...
              <div class="form-group d-flex flex-column align-items-center">
                <a href="{{Route('catalogo.index')}}">Ir a catalogo</a>
              </div>
    ...
    <script>
        ...
        function setQty2(herramienta_codigo){
          ...
          $.getJSON("inventario/getTool/"+herramienta_codigo, function(data) {
                  ...
                  const cantidad_fisica = herramienta.qtyf;
                  $("#cantidad_ajustar").prop('max',cantidad_fisica);
           ...
           if(herramienta_id !== '' && cantidad_ajustar !== '' && parseInt(cantidad_ajustar) > 0 && usuario !== '' && motivo !== ''){
            $.ajax({
              ...
              error: function(error) {
                toastr.error('Hubo un error en la parte del servidor', 'Error', {timeOut: 3000});
                $('#btn-confirm-ajuste').prop('disabled', false);
                return false;
              },
              success:function(data)
              {
