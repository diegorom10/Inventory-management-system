    ...
    function hacerCorte(data){
          ...
          function cargarResumenCorte(data){
            if(data == null){
                ...
                const consumidas = data.consumidas;
                ...
                let resumen = `
                            ...
                            <div class="d-flex flex-row">
                              <div class="form-group d-flex flex-column align-items-center mr-2" style="width:25%">
                                <label style="text-align: center;">Artículos registrados:</label>
                              ...
                              <div class="form-group d-flex flex-column align-items-center mr-2" style="width:25%">
                                <label style="text-align: center;">Total de unidades:</label>
                              ...
                              <div class="form-group d-flex flex-column align-items-center mr-2" style="width:25%">
                                <label style="text-align: center;">Unidades disponibles:</label>
                              ...
                              <div class="form-group d-flex flex-column align-items-center mr-2" style="width:25%;">
                                  <label style="text-align: center;">Total comprometidas:</label>
                            ...
                            <div class="d-flex flex-row">
                              ...
                              <div class="form-group d-flex flex-column align-items-center mr-2" style="width:33%;">
                                ...
                                <input type="text" class="form-control" id="input_consumidas" style="text-align:center; pointer-events:none;" value="${consumidas}" readonly>
                              </div>
