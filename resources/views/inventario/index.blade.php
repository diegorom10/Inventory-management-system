...
<div class="mt-4 container">
  <div class="botones" style="margin-bottom: 15px; text-align:center;">
    <div class="column">
      <button type="button" id="butonPrestamo" class="col-md-5 btn btn-lg m-2 btn-principales" data-backdrop="static" data-toggle="modal" data-target="#prestamoModal">Hacer un prestamo</button>
      <button type="button" id="buttonRegreso" class="col-md-5 btn btn-lg m-2 btn-principales" data-backdrop="static" data-toggle="modal" data-target="#regresoModal">Regresar un prestamo</button>
    </div>
    <div class="column">
      <button type="button" class="col-md-5 btn btn-lg m-2 btn-principales" data-backdrop="static" data-toggle="modal" data-target="#llegadaModal" id="buttonEntrada">Entrada de artículos</button>
      <button type="button" class="col-md-5 btn btn-lg m-2 btn-principales" data-backdrop="static" data-toggle="modal" data-target="#ajusteModal" id="buttonAjuste">Ajustes de artículos</button>
    </div>
  </div>
  <!--hacer_movimiento-->
  ...
  <div class="contenedor" style="margin-bottom: 25px">
    ...
    <colgroup>
      ...
      <td class="td-table">Codigo/SN</td>
        ...
        <td class="td-table">Prestado / Consumido</td>
      </thead>
    </table>
