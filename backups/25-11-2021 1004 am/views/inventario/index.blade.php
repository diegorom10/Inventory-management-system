...
<div class="mt-4 container">
  <div class="botones" style="margin-bottom: 15px; text-align:center;">
    ...
    <div class="column">
      <button style="border: solid #000 1px" type="button" class="btn1 col-md-5 btn btn-warning btn-lg m-2" data-backdrop="static" data-toggle="modal" data-target="#llegadaModal">Entrada de material</button>
  ...
  <div class="contenedor" style="margin-bottom: 25px">
    ...
    <div class="d-flex">
      <a href="{{Route('inventario.export')}}" style="background-color: #38A143; border:none; padding: 7px;" class="link-descarga btn btn-primary mx-2" title="Descargar el estado del inventario">Descargar Excel</a>
  ...
  @include('inventario.ajustesModal')
