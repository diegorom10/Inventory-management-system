    ...
    <form id="registro-tipo">
      ...
      <div class="form-inline">
          ...
          <div class="centerbutton">
            <button style="margin-left: 10px;" type="submit" class="botontipo btn add">Registrar tipo</button>
          </div>
      </div>
...
<hr class="pb-2">
    <div class="mt-4 mb-4">
      <table id="tabla-tipo" class="cell-border hover">
        <thead>
          <td class="td-table" id="tipo" colspan="1">Tipo</td>
          <td class="td-table" style="display: none;">‎‍‍‍‍‍‎ ‏‏‎‎ ‏‏‎‎ ‏‏‎‏‏‎‎ ‏‏‎‎ ‎‍‍‍‍‍‎ ‏‏‎‎ ‏‏‎‎ ‏‏‎‏‏‎‎ ‏‏‎‎ ‎‍‍‍‍‍‎ ‏‏‎‎ ‏‏‎‎ ‏‏‎‏‏‎‎ ‏‏‎‎ ‎‍‍‍‍‍‎ ‏‏‎‎ ‏‏‎‎ ‏‏‎‏‏‎‎ ‏‏‎‎ ‎‍‍‍‍‍‎ ‏‏‎‎ ‏‏‎‎ ‏‏‎‏‏‎‎ ‏‏‎‎ </td>
