          ...
          <div class="modal-body">
            ...
            <form id="add-form" style="width: 80%">  
              ...
              <div class="form-group d-flex flex-column align-items-center">
                  ...
                  <div class="col-md-3">
									  <input type="number" min="0" max="100" name="cantidad" id="cantidad_actual" class="form-control input-entrada" readonly>
                  </div>
              </div>
              <div class="form-group d-flex flex-column align-items-center">
              ...
              <div class="form-group d-flex flex-column align-items-center">
                  ...
                  <div class="col-md-3">
									  <input type="number" min="1" max="100" name="cantidad" id="cantidad_nueva" class="form-control input-entrada" readonly>
                  </div>
              </div>
              <div class="form-group d-flex flex-column align-items-center">
            ...
            <div class="modal fade" id="confirmEntrada" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                  ...
                  <div class="modal-body">
                      ...
                      <div id="resumen-entrada" class="d-flex flex-column">
